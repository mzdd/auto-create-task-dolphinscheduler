...
public class TaskDefinitionLog extends TaskDefinition {
    ...
    public TaskDefinitionLog(long code, String description, String name, TaskParams taskParams) {
        this.setCode(code);
        this.setDelayTime(0);
        this.setDescription(description);
        this.setEnvironmentCode(RunParamConstant.DS_ENVIRONMENT_CODE);
        this.setFailRetryInterval(1);
        this.setFailRetryTimes(0);
        this.setFlag("YES");
        this.setName(name);
        ...
        this.setTimeoutNotifyStrategy("");
        this.setWorkerGroup("default");
        this.setTaskParamList(new ArrayList<>());
    }
